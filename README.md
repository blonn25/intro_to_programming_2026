...
| ------------- | -------------- | ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Tuesday** | **09/08/2025** | CoreHPC (onboarding) | Terminal basics, ssh, CoreHPC sign-up / sign-in, SLURM, job creation + submission                                                                                                                                            |
...
| **Thursday** | **09/10/2025** | Python Day1         | Introduction to Python Programming (writing and running scripts, basic maths, commenting, variables, strings, slicing, user input) + `greeter.py`                                                    |
